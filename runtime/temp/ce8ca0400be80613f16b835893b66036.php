<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\project\point\point\public/../module/admin\view\horn\index.html";i:1527475418;s:67:"D:\project\point\point\public/../module/admin\view\public\base.html";i:1516416741;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="layui-btn-group">
    <a class="layui-btn layui-btn-sm" href="<?php echo url('@admin/horn/add'); ?>"><i class="layui-icon">&#xe61f;</i> 添加</a>
</div>
<table class="layui-table" lay-data="{ url:'<?php echo url("@admin/horn/data"); ?>', page:true, id:'data', limit:<?php echo $config['page_num']; ?>}" lay-filter="data">
	<thead>
		<tr> 			
...
layui.use(['form', 'layedit','table', 'laydate','element'], function(){
    ...
    ,element = layui.element,table = layui.table;    
 	...
 	function table_reload(data){
        if(data.code=='1'){
            table.reload('data', {
                url: '<?php echo url("@admin/horn/data"); ?>', page: {
                        curr: 1 //重新从第 1 页开始
                }
            });
        }
	...
	table.on('tool(data)', function(obj){
		var data = obj.data;
		if(obj.event === 'edit'){ 
			location.href = "<?php echo url('@admin/horn/edit'); ?>" +'?id='+ data.id; 
        }else if(obj.event==='del'){
			parent.$.fn.jcb.confirm(true,'确定删除吗?','<?php echo url("@admin/horn/del"); ?>',table_reload,{'id':data.id}); 				
		} 
	}); 
});
</script>
