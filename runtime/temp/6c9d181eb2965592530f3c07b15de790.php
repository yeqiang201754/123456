<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\web\point\public/../module/admin\view\article\edit.html";i:1526112188;s:57:"D:\web\point\public/../module/admin\view\public\base.html";i:1516416741;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-input-inline">
            <select lay-filter="type" name="type">
                <option value="">请选择</option>
                    ...
                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $list['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="front" lay-verify="required" value="<?php echo $list['front']; ?>" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-input-block">
        <div class="layui-upload-list">
            <img class="layui-upload-img" src="<?php echo (isset($list['picture']) && ($list['picture'] !== '')?$list['picture']:'/resource/images/bakimg.png'); ?>" id="img_picture">
        </div>
        </div>
    </div> 
