<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\web\point\public/../module/admin\view\exchange\edit.html";i:1526096115;s:57:"D:\web\point\public/../module/admin\view\public\base.html";i:1516416741;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="bankid" lay-verify="required">
                ...
                <option value="<?php echo $data['id']; ?>" <?php if($data['id'] == $list['bankid']): ?> selected <?php endif; ?>><?php echo $data['bankname']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="price" lay-verify="required" value="<?php echo $list['price']; ?>" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width:180px;">兑换规则</label>
        <div class="layui-input-inline">
            <input type="text" name="click" value="<?php echo $list['click']; ?>" autocomplete="off" class="layui-input">
        </div>
    </div>
