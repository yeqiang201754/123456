<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\web\point\public/../module/index\view\article\detail.html";i:1526000889;s:11:"footer.html";i:1525945441;}*/ ?>
...
<body style="background-color:white;">
    <form method="post" id="form1">
        <div class="layout">
            <div class="header">
                <div class="inner">
                    <a href="/index/article/index" class="return"></a>
            ...
            <div class="home_product">
                ...
                font-size: 14px;">
                    <tr>
                        <td colspan="2" style="text-align: center; padding: 5px; font-size:20px; font-weight:bold;" align="center">
                            <?php echo $detail['title']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" style="text-align: left; padding: 5px;" align="center">
                            发布：<?php echo $detail['addtime']; ?>
                        </td>
                        <td colspan="1" style="text-align: right; padding: 5px;" align="center">
                            阅读：<?php echo $detail['click']; ?>
                        </td>
                    </tr>
                    <tr>
